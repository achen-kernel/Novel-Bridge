#!/usr/bin/env python3
"""
vtl_closing.py — Verify vibe-learn_remote Closing Checklist items.
...
def find_state(root: Path):
    """Read docs/learn_remote/vtl-state.json for active stage."""
...
def main():
    parser = argparse.ArgumentParser(description="Verify vibe-learn_remote Closing Checklist items.")
    ...
    if adapter:
        ...
        docs_root_str = adapter.get("docs_root", "docs/learn_remote")
    else:
        backend_root = root
        docs_root_str = "docs/learn_remote"
