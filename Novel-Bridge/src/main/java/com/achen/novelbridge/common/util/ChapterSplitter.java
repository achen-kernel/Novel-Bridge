package com.achen.novelbridge.common.util;
...
public final class ChapterSplitter {
     ...
     */
    // @VTL-PRACTICE version=demo-2 name=chineseToInt
    // goal=中文数字转整数：一百二十三 → 123
    // prerequisites=理解中文数字的位值系统（十、百、千）
    // inputs=Chinese numeral string e.g. "第二十回"
    // outputs=integer chapter number
    // pitfalls=十前面没数字时默认1倍；Arabic numeral直接解析
    // hints=一加一等于二，十加一等于十一，二十加一等于二十一
